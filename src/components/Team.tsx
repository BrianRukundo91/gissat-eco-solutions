...
const Team = () => {
  const teamMembers: TeamMember[] = [
    ...
    },
    {
      ...
      shortBio: "A growth-focused and innovative leader leveraging over 6 years of professional experience in operations, finance, and environmental engineering.",
      fullBio: [
    ...
    },
    {
      ...
      shortBio: "Environmental engineer with over five years' experience in environmental consulting, project management, and team leadership.",
      fullBio: [
    ...
    },
    {
      ...
      shortBio: "A proactive Office Administrator with 8+ years of experience managing office operations and developing efficient administrative processes.",
      fullBio: [
    ...
    },
    {
      ...
      shortBio: "Experienced specialist in field research, socio-economic surveys, stakeholder engagement, and social impact assessment processes.",
      fullBio: [
              ...
              <CardContent className="space-y-4">
                ...
                <Dialog>
                  <DialogTrigger asChild>
                    <Button variant="ghost" className="w-full justify-between text-primary hover:text-primary/80 hover:bg-primary/10">
                      Read More
