...
const categories: Category[] = [
...

  {
    ...
    projects: [
      ...
      {
        shortTitle: "Anderita Beach Hotel ECA — ABHL, Entebbe",
        title: "Environmental Compliance Audit for Anderita Beach Hotel and Ancillary Facilities, Plot 05, Nambi Road, Manyango 'II' Village, Entebbe Municipality, Wakiso District",
        client: "Anderita Beach Hotel Limited (ABHL)",
        serviceType: "ECA",
        description: [
          "Anderita Beach Hotel Limited (ABHL) owns and operates a beach resort facility located on Plot 5 in Manyango II within Entebbe Municipality. The resort's location offers a unique blend of proximity to the city and scenic Lake Victoria views, making it a main attraction for potential patrons.",
          ...
          "The audit was also carried out to assess the impact of the Hotel's activities on the adjacent Lake Victoria. The operation of ABHL is subject to the provision of the National Environmental Act 2019.",
        ],
        services: [
          "The audit was conducted through reviewing previous audit reports, facility inspections and stakeholder consultations to understand the project components and ongoing activities at the resort.",
          "Areas of emphasis included air and noise pollution, water pollution control, occupational health and safety, and wastewater management.",
        ],
      },
      {
        shortTitle: "Onomo Hotel Kampala ESIA — Akii Bua Road, Nakasero",
        title: "Environmental and Social Impact Assessment for the Development of Onomo Hotel Kampala, Akii Bua Road, Nakasero, Kampala",
        client: "Onomo Hotel",
        serviceType: "ESIA",
        description: [
          "An Environmental and Social Impact Assessment was conducted for the Onomo Kampala Hotel — part of the Onomo Hotel Chain with hotels in Western and Eastern Africa.",
          ...
          "A positive Record of Decision was issued for the facility by the National Environment Management Authority (NEMA).",
        ],
        services: [
          "The ESIA covered extensive public consultation and involvement processes and numerous detailed specialist investigations to assess impacts on the physical, biological and socio-economic environment.",
          "The assessment was conducted in line with the National Environment Act, 2019 and National EIA Guidelines-1997, leading to a successful NEMA approval.",
        ],
      },
      {
        shortTitle: "Latitude 0 Degrees ESIA — Kampala",
        title: "Environmental and Social Impact Assessment for Latitude 0 Degrees, Kampala",
        client: "Latitude 0 Degrees",
        serviceType: "ESIA",
        description: [
          "Comprehensive environmental impact assessment and management plan for a major commercial development project in Kampala's central business district.",
          "Gissat was contracted to conduct an EIA and develop an Environmental Management Plan to address potential environmental impacts of the proposed project on the surrounding environment.",
        ],
        services: [
          "The EIA covered environmental permits, impact assessment and compliance monitoring to ensure the project met all regulatory requirements under the National Environment Act, 2019.",
          "Field investigations established baseline physical, biological and socio-economic data, and an Environmental Management Plan was developed to mitigate identified impacts.",
        ],
      },
      {
        shortTitle: "Vocational Development Centre ECA — YES, Fort Portal",
        title: "Environmental Compliance Audit for the Vocational Development Centre, Kitebulura 'B' Cell, Fort Portal City, Kabarole District",
        client: "Youth Encouragement Services (YES)",
        serviceType: "ECA",
        description: [
          "Youth Encouragement Services (YES) is a registered Community-Based Organization providing vocational education and practical skilling to the youths of Kabarole and surrounding districts in South Western Uganda, covering pottery, mechanical engineering, hairdressing, cookery, welding and carpentry.",
          "Gissat was contracted to conduct an Environmental Compliance Audit to assess whether the mitigation and monitoring measures recommended in the facility's ESMP were achieving their intended objectives and to make recommendations for the way forward.",
          "The audit criteria complied with the policies, laws, guidelines, standards and permitting requirements relevant to the Vocational Development Centre's operations.",
        ],
        services: [
          "The study was carried out through measurements, interviews and observations to ensure the facility's operations were in line with relevant regulations.",
        ...
        highlights: [
          ...
          "Reporting the extent to which avoidance, management and mitigation measures achieve objectives and outcomes",
          "Identifying and assessing any new impacts and risks resulting from undertaking the activity",
        ],
        highlightsLabel: "Audit Objectives",
      },
    ],
  },
